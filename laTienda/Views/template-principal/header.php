...
<head>
    ...
    <!-- Favicon para los distintos modelos de pantallas -->
    ...
    <link rel="apple-touch-icon" href="<?php echo BASE_URL . 'assets/img/apple-icon.png'; ?>a">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="#" id="verCarrito">
                        ...
                        <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark" id="btnCantidadCarro">0</span>
                    </a>
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="#">
                        ...
                        <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark">44</span>
                    </a>
                </div>
            </div>
